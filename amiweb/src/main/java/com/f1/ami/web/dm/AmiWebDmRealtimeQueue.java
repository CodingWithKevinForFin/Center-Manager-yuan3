...
public class AmiWebDmRealtimeQueue implements AmiWebRealtimeObjectListener {
	...
	public void onAmiEntitiesReset(AmiWebRealtimeObjectManager manager) {
		//TODO: remove all events for the  corresponding realtimeid
		addRealtimeEvent(new AmiWebDmRealtimeEvent(manager.getRealtimeId(), manager.getRealtimeId(), null, null, AmiWebDmRealtimeEvent.TRUNCATE));
