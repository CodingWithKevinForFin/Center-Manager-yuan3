...
public abstract class AmiCenterManagerAbstractAddObjectPortlet extends FormPortlet
	...
	protected FormPortletTextField nameField;
	...
	private final FormPortletButton importButton = new FormPortletButton("Import");
	private final FormPortletButton exportButton = new FormPortletButton("Export");
	...
	public AmiCenterManagerAbstractAddObjectPortlet(PortletConfig config, byte groupCode) {
		...
		this.nameField = new FormPortletTextField(AmiCenterManagerUtils.formatPreviewScript("Name"));
	...
	public String preparePreUseClause() {
		...
		Object nameFieldValue = this.nameField.getValue();
