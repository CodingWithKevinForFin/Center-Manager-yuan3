...
public class AmiWebScriptMemberMethods_MouseEvent extends AmiWebScriptBaseMemberMethods<MouseEvent> {
	...
	private static final AmiAbstractMemberMethod<MouseEvent> GET_RELATIVE_POSITION = new AmiAbstractMemberMethod<MouseEvent>(MouseEvent.class, "getRelativePosition", WebPoint.class,
			AmiWebPortlet.class) {
		@Override
		public Object invokeMethod2(CalcFrameStack sf, MouseEvent targetObject, Object[] params, DerivedCellCalculator caller) {
	...
	private static final AmiAbstractMemberMethod<MouseEvent> GET_EVENT = new AmiAbstractMemberMethod<MouseEvent>(MouseEvent.class, "getEvent", Boolean.class) {
		@Override
		public Object invokeMethod2(CalcFrameStack sf, MouseEvent targetObject, Object[] params, DerivedCellCalculator caller) {
		...
		@Override
		protected String getHelp() {
			return "Returns the type of mouse event. The available types are CLICK, CONTEXTMENU, DOUBLECLICK, DOWN, or UP.";
		}
