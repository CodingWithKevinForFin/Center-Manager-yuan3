...
public class AmiWebScriptMemberMethods_SpreadSheetBuilder extends AmiWebScriptBaseMemberMethods<AmiWebSpreadSheetBuilder> {
	...
	private static final AmiAbstractMemberMethod<AmiWebSpreadSheetBuilder> GET_WORK_SHEET = new AmiAbstractMemberMethod<AmiWebSpreadSheetBuilder>(AmiWebSpreadSheetBuilder.class,
		...
		@Override
		protected String getHelp() {
			return "Returns an existing worksheet with the input name. (Returned type is a base class of either AmiWebSpreadsheet or AmiWebFlexsheet";
		}
	...
	private static final AmiAbstractMemberMethod<AmiWebSpreadSheetBuilder> HIDE_SHEET = new AmiAbstractMemberMethod<AmiWebSpreadSheetBuilder>(AmiWebSpreadSheetBuilder.class, "hideSheet",
	...
	private static final AmiAbstractMemberMethod<AmiWebSpreadSheetBuilder> SHOW_SHEET = new AmiAbstractMemberMethod<AmiWebSpreadSheetBuilder>(AmiWebSpreadSheetBuilder.class, "showSheet",
			Boolean.class, String.class) {
	...
	private static final AmiAbstractMemberMethod<AmiWebSpreadSheetBuilder> GET_EXCEL_POSITION = new AmiAbstractMemberMethod<AmiWebSpreadSheetBuilder>(AmiWebSpreadSheetBuilder.class,
			"getExcelPosition", String.class, Integer.class) {
	...
	private static final AmiAbstractMemberMethod<AmiWebSpreadSheetBuilder> SET_TIMEZONE_OFFSET = new AmiAbstractMemberMethod<AmiWebSpreadSheetBuilder>(AmiWebSpreadSheetBuilder.class,
			"setTimezoneOffset", Boolean.class, String.class) {
	...
	private static final AmiAbstractMemberMethod<AmiWebSpreadSheetBuilder> SET_TIMEZONE_OFFSET2 = new AmiAbstractMemberMethod<AmiWebSpreadSheetBuilder>(AmiWebSpreadSheetBuilder.class,
			"setTimezoneOffset", Boolean.class, Long.class) {
