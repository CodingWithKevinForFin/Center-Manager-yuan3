...
public class AmiWebCustomColumn implements WebColumnEditConfig, AmiWebDomObject, AmiWebFormulasListener {
	...
	private String enableLastNDays;
	private String ari;
	...
	public AmiWebCustomColumn(AmiWebAbstractTablePortlet table, String id, String title, byte type, int precision, String formula, String colorFormula,
		...
		this(table, id, title, type, precision, formula, colorFormula, backgroundColorFormula, styleFormula, headerStyle, sort, null, EDIT_DISABLED, null, null, null, null,
				isAggregate, tooltip, fixedWidth);
	}
	//Constructor for AmiWebAbstractTablePortlet 
	private AmiWebCustomColumn(AmiWebAbstractTablePortlet table, String id, String title, byte type, int precision, String formula, String colorFormula,
			...
			String clickable, String oneClick, boolean isAggregate, String tooltip, boolean fixedWidth) {
	...
	public AmiWebCustomColumn(AmiWebAbstractTablePortlet table, Map<String, Object> m, boolean isAggregate) {
		...
		this.enableLastNDays = SH.toNull(CH.getOr(Caster_String.INSTANCE, m, CONFIG_ENABLE_LAST_N_DAYS, null));
	...
	public Map<String, Object> getColumnConfig() {
		...
		CH.putNoNull(columnConfig, AmiWebCustomColumn.CONFIG_HEADER_STYLE, this.headerStyle.getValue());
		CH.putNoNull(columnConfig, AmiWebCustomColumn.CONFIG_SORT, this.sortFormula.getFormulaConfig());
		CH.putNoNull(columnConfig, AmiWebCustomColumn.CONFIG_EDIT_ID, this.editId.getValue());
		...
		CH.putNoNull(columnConfig, AmiWebCustomColumn.CONFIG_EDIT_OPTIONS, this.getEditSelectOptions()); // Old
		CH.putNoNull(columnConfig, AmiWebCustomColumn.CONFIG_EDIT_OPTIONS_FORMULA, this.getEditOptionFormula());
		...
		CH.putNoNull(columnConfig, AmiWebCustomColumn.CONFIG_FIXED_WIDTH, this.isFixedWidth());
	...
	public String getEnableLastNDays() {
		return SH.is(this.enableLastNDays) ? enableLastNDays : "";
	}
	public void setEnableLastNDays(String enableLastNDays) {
