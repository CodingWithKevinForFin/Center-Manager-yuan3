...
public class AmiWebStyleConsts {
	...
	//	public static final String PROPERTY_NAME_FLD_CSS_CHECK = "fldCssCheck";
	//	public static final String PROPERTY_NAME_FLD_CSS_DATE = "fldCssDate";
	//	public static final String PROPERTY_NAME_FLD_CSS_DATE_RNG = "fldCssDateRng";
	//	public static final String PROPERTY_NAME_FLD_CSS_DATE_TIME = "fldCssDateTime";
	//	public static final String PROPERTY_NAME_FLD_CSS_DIV = "fldCssDiv";
	//	public static final String PROPERTY_NAME_FLD_CSS_BTN = "fldCssBtn";
	//	public static final String PROPERTY_NAME_FLD_CSS_IMG = "fldCssImg";
	//	public static final String PROPERTY_NAME_FLD_CSS_MULTI_SEL = "fldCssMultiSel";
	//	public static final String PROPERTY_NAME_FLD_CSS_RNG = "fldCssRng";
	//	public static final String PROPERTY_NAME_FLD_CSS_SEL = "fldCssSel";
	//	public static final String PROPERTY_NAME_FLD_CSS_SUB_RNG = "fldCssSubRng";
	//	public static final String PROPERTY_NAME_FLD_CSS_TXT_AREA = "fldCssTxtArea";
	//	public static final String PROPERTY_NAME_FLD_CSS_TXT = "fldCssTxt";
	//	public static final String PROPERTY_NAME_FLD_CSS_TIME = "fldCssTime";
	//	public static final String PROPERTY_NAME_FLD_CSS_TIME_RNG = "fldCssTimeRng";
	//	public static final String PROPERTY_NAME_FLD_CSS_UPLOAD = "fldCssUpload";
