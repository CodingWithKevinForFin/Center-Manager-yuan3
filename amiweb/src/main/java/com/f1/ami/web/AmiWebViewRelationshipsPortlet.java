...
public class AmiWebViewRelationshipsPortlet extends AmiWebScmBasePortlet
	...
	public static final String COLUMN_SOURCE_PANEL_VISIBILITY = "Source Panel Visibility";
	public static final String COLUMN_TARGET_PANEL_VISIBILITY = "Target Panel Visibility";
	public static final String COLUMN_RELATIONSHIP = "Relationship";
	public static final String COLUMN_LINK = "Link";
	public static final String COLUMN_REL_BEHAVIOR = "Run On";

	public static final String STATUS_PANEL_HIDDEN = "Hidden";
	public static final String STATUS_PANEL_VISIBLE = "Visible";
	...
	public WebMenu createMenu(WebTable table) {
		...
		if (this.fastTable.getTable().getSelectedRows().size() == 1) {
			...
			menu.add(new BasicWebMenuLink(link.getSourcePanelNoThrow().getVisible() ? "Show Source Panel" : "Show Source Panel (Hidden)",
					link.getSourcePanelNoThrow().getVisible() ? true : false, "show_src_panel"));
			menu.add(new BasicWebMenuLink(link.getTargetPanelNoThrow().getVisible() ? "Show Target Panel" : "Show Target Panel (Hidden)",
					link.getTargetPanelNoThrow().getVisible() ? true : false, "show_target_panel"));
