...
public class AmiWebTabPortlet extends AmiWebAbstractContainerPortlet
	...
	public WebMenu createMenu(FormPortlet formPortlet, FormPortletField<?> field, int cursorPosition) {
		...
		com.f1.base.CalcTypes types = dm.isEmpty() ? EmptyCalcTypes.INSTANCE : CH.first(dm).getClassTypes();
		BasicWebMenu vars = (BasicWebMenu) AmiWebMenuUtils.createVariablesMenu("Variables", "", types);
