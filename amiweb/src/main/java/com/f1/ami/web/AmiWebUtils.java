...
public class AmiWebUtils {
	...
	public static String getRelativeAlias(String parent, String fullAlias) {
		...
		throw new RuntimeException("Not a child of parent: " + parent + " => " + fullAlias);
	}
	...
	public static Table toTable(com.f1.base.CalcTypes cols, List<AmiWebObject> selected) {
		if (cols.isVarsEmpty())
	...
	public static String getRelativeRealtimeId(String amiLayoutFullAlias, String s) {
		if (SH.startsWith(s, AmiWebManagers.FEED))
			return s;
		final int i = s.indexOf(':') + 1;
		return s.substring(0, i) + AmiWebUtils.getRelativeAlias(amiLayoutFullAlias, s.substring(i));
	}
