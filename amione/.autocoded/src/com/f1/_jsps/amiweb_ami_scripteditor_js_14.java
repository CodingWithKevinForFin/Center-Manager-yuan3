...
public class amiweb_ami_scripteditor_js_14 extends AbstractHttpHandler{

	public amiweb_ami_scripteditor_js_14() {
	}
	...
	public void handle(HttpRequestResponse request) throws java.io.IOException{
	  ...
	  LocaleFormatter formatter = session == null ? server.getHttpSessionManager().getDefaultFormatter() : session.getFormatter();
          out.print(
            ...
            "    c.comparePoint = function(e) {\r\n"+
            "        return c.compare(e.row, e.column)\r\n"+
            "    }\r\n"+
            ...
            "    var cords=this.editor.renderer.textToScreenCoordi");
          out.print(
            "nates(this.editor.selection.getCursor());\r\n"+
            "\r\n"+
