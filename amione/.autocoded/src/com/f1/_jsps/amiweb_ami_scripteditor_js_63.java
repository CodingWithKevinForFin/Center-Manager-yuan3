...
public class amiweb_ami_scripteditor_js_63 extends AbstractHttpHandler{

	public amiweb_ami_scripteditor_js_63() {
	}
	...
	public void handle(HttpRequestResponse request) throws java.io.IOException{
	  ...
	  LocaleFormatter formatter = session == null ? server.getHttpSessionManager().getDefaultFormatter() : session.getFormatter();
          out.print(
            ...
            "    	var i = t.selection.getWordRange(i.row, i.column);//start/end pos of the word\r\n"+
            "    	 tooltip.show(\"dbl click:\" + t.getSelectedText(), e.clientX, e.clientY + 10);\r\n"+
            "    	});\r\n"+
            "    \r\n"+
