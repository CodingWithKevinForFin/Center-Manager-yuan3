...
public class amiweb_ami_scripteditor_js_62 extends AbstractHttpHandler{

	public amiweb_ami_scripteditor_js_62() {
	}
	...
	public void handle(HttpRequestResponse request) throws java.io.IOException{
	  ...
	  LocaleFormatter formatter = session == null ? server.getHttpSessionManager().getDefaultFormatter() : session.getFormatter();
          out.print(
            ...
            "	this");
          out.print(
            ".editor.selection.moveCursorToPosition(this.editor.getSession().doc.indexToPosition(i));\r\n"+
            "	//this.editor.focus();\r\n"+
            "};\r\n"+
