...
public class amiweb_ami_scripteditor_js_11 extends AbstractHttpHandler{

	public amiweb_ami_scripteditor_js_11() {
	}
	...
	public void handle(HttpRequestResponse request) throws java.io.IOException{
	  ...
	  LocaleFormatter formatter = session == null ? server.getHttpSessionManager().getDefaultFormatter() : session.getFormatter();
          out.print(
            ...
            "	var ");
          out.print(
            "editorCP = this.editor.getSession().doc.positionToIndex(this.editor.selection.getCursor());\r\n"+
            "    var position = null;\r\n"+
            "\r\n"+
