...
public class amiweb_ami_scripteditor_js_51 extends AbstractHttpHandler{

	public amiweb_ami_scripteditor_js_51() {
	}
	...
	public void handle(HttpRequestResponse request) throws java.io.IOException{
	  ...
	  LocaleFormatter formatter = session == null ? server.getHttpSessionManager().getDefaultFormatter() : session.getFormatter();
          out.print(
            ...
            "    	 tooltip.show(\"dbl click\", e.clientX, e.clientY + 10);\r\n"+
            "    	});\r\n"+
            "    \r\n"+
            "    //\r\n"+
            "    \r\n"+
            ...
            "    this.element.style.width=toPx(this.wi");
          out.print(
            "dth);\r\n"+
            "	this.editor.resize();\r\n"+
            "}\r\n"+
