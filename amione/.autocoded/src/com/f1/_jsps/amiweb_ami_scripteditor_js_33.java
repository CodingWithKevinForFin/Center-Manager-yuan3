...
public class amiweb_ami_scripteditor_js_33 extends AbstractHttpHandler{

	public amiweb_ami_scripteditor_js_33() {
	}
	...
	public void handle(HttpRequestResponse request) throws java.io.IOException{
	  ...
	  LocaleFormatter formatter = session == null ? server.getHttpSessionManager().getDefaultFormatter() : session.getFormatter();
          out.print(
            ...
            "	var tooltip = new Tooltip(editor.renderer.scroller);\r\n"+
            "	tooltip.show(\"Hello!\", 100, 50);\r\n"+
            "	// …\r\n"+
            "	tooltip.hide();\r\n"+
            "\r\n"+
            "	\r\n"+
            ...
            "    var co");
          out.print(
            "rds=this.editor.renderer.textToScreenCoordinates(this.editor.selection.getCursor());\r\n"+
            "\r\n"+
