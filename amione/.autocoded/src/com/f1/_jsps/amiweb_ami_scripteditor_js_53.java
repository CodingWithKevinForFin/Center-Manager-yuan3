...
public class amiweb_ami_scripteditor_js_53 extends AbstractHttpHandler{

	public amiweb_ami_scripteditor_js_53() {
	}
	...
	public void handle(HttpRequestResponse request) throws java.io.IOException{
	  ...
	  LocaleFormatter formatter = session == null ? server.getHttpSessionManager().getDefaultFormatter() : session.getFormatter();
          out.print(
            ...
            "    	 tooltip.show(\"dbl click:\" + that.getSelectedText(), e.clientX, e.clientY + 10);\r\n"+
            "    	});\r\n"+
            "    \r\n"+
            "    //\r\n"+
            "    \r\n"+
            ...
            "	this.element.style.height=toPx(this.heig");
          out.print(
            "ht);\r\n"+
