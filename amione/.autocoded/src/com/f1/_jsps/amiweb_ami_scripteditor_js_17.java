...
public class amiweb_ami_scripteditor_js_17 extends AbstractHttpHandler{

	public amiweb_ami_scripteditor_js_17() {
	}
	...
	public void handle(HttpRequestResponse request) throws java.io.IOException{
	  ...
	  LocaleFormatter formatter = session == null ? server.getHttpSessionManager().getDefaultFormatter() : session.getFormatter();
          out.print(
            ...
            "    var cords=this.ed");
          out.print(
            "itor.renderer.textToScreenCoordinates(this.editor.selection.getCursor());\r\n"+
            "\r\n"+
