...
public class amiweb_ami_scripteditor_js_31 extends AbstractHttpHandler{

	public amiweb_ami_scripteditor_js_31() {
	}
	...
	public void handle(HttpRequestResponse request) throws java.io.IOException{
	  ...
	  LocaleFormatter formatter = session == null ? server.getHttpSessionManager().getDefaultFormatter() : session.getFormatter();
          out.print(
            ...
            "	tooltip.show(\"Hello world\", 100, 200);\r\n"+
            "	// later...\r\n"+
            "	tooltip.hide();\r\n"+
            "\r\n"+
            "	\r\n"+
            ...
            "	var editorCP = th");
          out.print(
            "is.editor.getSession().doc.positionToIndex(this.editor.selection.getCursor());\r\n"+
            "    var position = null;\r\n"+
            "\r\n"+
