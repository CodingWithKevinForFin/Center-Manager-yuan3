...
public class amiweb_ami_scripteditor_js_25 extends AbstractHttpHandler{

	public amiweb_ami_scripteditor_js_25() {
	}
	...
	public void handle(HttpRequestResponse request) throws java.io.IOException{
	  ...
	  LocaleFormatter formatter = session == null ? server.getHttpSessionManager().getDefaultFormatter() : session.getFormatter();
          out.print(
            ...
            "		position = e.key == \"Backspace\"? (editorCP == 0? 0 : editorCP - 1): (e.key == \"Delete\" || e.altKey ||");
          out.print(
            " e.ctrlKey)?editorCP: editorCP + 1;\r\n"+
            "	else\r\n"+
            "		position = editorCP;\r\n"+
