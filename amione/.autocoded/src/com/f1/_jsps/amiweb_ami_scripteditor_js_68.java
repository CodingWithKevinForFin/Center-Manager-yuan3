...
public class amiweb_ami_scripteditor_js_68 extends AbstractHttpHandler{

	public amiweb_ami_scripteditor_js_68() {
	}
	...
	public void handle(HttpRequestResponse request) throws java.io.IOException{
	  ...
	  LocaleFormatter formatter = session == null ? server.getHttpSessionManager().getDefaultFormatter() : session.getFormatter();
          out.print(
            ...
            "    	 tooltip.show(\"dbl click:\" + t.getSelectedText(), wordStartCoord.pageX, wordStartCoord.pageY + 10);\r\n"+
            "    	});\r\n"+
            "    \r\n"+
