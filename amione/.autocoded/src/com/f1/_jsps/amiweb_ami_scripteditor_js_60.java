...
public class amiweb_ami_scripteditor_js_60 extends AbstractHttpHandler{

	public amiweb_ami_scripteditor_js_60() {
	}
	...
	public void handle(HttpRequestResponse request) throws java.io.IOException{
	  ...
	  LocaleFormatter formatter = session == null ? server.getHttpSessionManager().getDefaultFormatter() : session.getFormatter();
          out.print(
            ...
            "	this.editor.selection.moveCursorToPosition(this.editor.getSession().doc.indexTo");
          out.print(
            "Position(i));\r\n"+
            "	//this.editor.focus();\r\n"+
            "};\r\n"+
