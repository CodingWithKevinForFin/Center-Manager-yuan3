...
public class amiweb_ami_scripteditor_js_61 extends AbstractHttpHandler{

	public amiweb_ami_scripteditor_js_61() {
	}
	...
	public void handle(HttpRequestResponse request) throws java.io.IOException{
	  ...
	  LocaleFormatter formatter = session == null ? server.getHttpSessionManager().getDefaultFormatter() : session.getFormatter();
          out.print(
            ...
            "	this.editor.selection.moveCursorToPosition(this.editor.getSession().doc.indexToP");
          out.print(
            "osition(i));\r\n"+
            "	//this.editor.focus();\r\n"+
            "};\r\n"+
