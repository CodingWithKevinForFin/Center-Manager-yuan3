...
public class amiweb_ami_scripteditor_js_48 extends AbstractHttpHandler{

	public amiweb_ami_scripteditor_js_48() {
	}
	...
	public void handle(HttpRequestResponse request) throws java.io.IOException{
	  ...
	  LocaleFormatter formatter = session == null ? server.getHttpSessionManager().getDefaultFormatter() : session.getFormatter();
          out.print(
            ...
            "//        // e has .clientX/.clientY (pixel coords) and .getDocumentPosition()\r\n"+
            "//        var textPos = e.getDocumentPosition();\r\n"+
            "//        var message = \"Line \" + (textPos.row+1) + \", Col \" + textPos.column;\r\n"+
            "//\r\n"+
            "//        // show(text, x, y)\r\n"+
            "//        // you may want to offset the Y so it doesn’t sit exactly under the pointer\r\n"+
            "//        tooltip.show(message, e.clientX, e.clientY + 10);\r\n"+
            "//      });\r\n"+
            "//    \r\n"+
            "//    this.editor.on(\"mouseout\", function() {\r\n"+
            "//        tooltip.hide();\r\n"+
            "//    });\r\n"+
            "    this.editor.on(\"dblclick\", function(e) {\r\n"+
            "    	  // at this point Ace’s internal mouse handler has already\r\n"+
            "    	  // expanded the selection to the word under the cursor…\r\n"+
            "    	  console.log(\"you double-clicked on:\", editor.getSelectedText());\r\n"+
            "    	  tooltip.show(\"you double-clicked on:\", editor.getSelectedText(), e.clientX, e.clientY + 10);\r\n"+
            "    	});\r\n"+
            "    \r\n"+
            "    //\r\n"+
            "    \r\n"+
            ...
            "\r\n"+
            "//add\r\n"+
            "AmiCodeField.prototype.selectFuncParam=function(start) {\r\n"+
            "\r\n"+
            ...
            "Ami");
          out.print(
            "CodeField.prototype.moveScrollLeft=function(pageX){\r\n"+
