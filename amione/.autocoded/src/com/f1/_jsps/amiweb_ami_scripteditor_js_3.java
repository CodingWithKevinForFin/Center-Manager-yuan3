...
public class amiweb_ami_scripteditor_js_3 extends AbstractHttpHandler{

	public amiweb_ami_scripteditor_js_3() {
	}
	...
	public void handle(HttpRequestResponse request) throws java.io.IOException{
	  ...
	  LocaleFormatter formatter = session == null ? server.getHttpSessionManager().getDefaultFormatter() : session.getFormatter();
          out.print(
            ...
            "    	 tooltip.show(\"String\" + t.getSelectedText(), wordStartCoord.pageX, wordStartCoord.pageY + 15);\r\n"+
            "    	});\r\n"+
            "    \r\n"+
            ...
            "	\r\n"+
            "	this.acMethodName = arguments[0];\r\n"+
            "	this.acMethodVarTypes = const slicedArgs = args.slice(1);\r\n"+
            "	\r\n"+
            "	\r\n"+
            "}\r\n"+
            "\r\n"+
            ...
            "	    this.por");
          out.print(
            "tlet.onKey(this.id,e,{pos:this.getCursorPosition()});\r\n"+
            "	  if(e.ctrlKey && e.key== \" \")\r\n"+
            "		  e.stopPropagation();\r\n"+
            "  }\r\n"+
            "};\r\n"+
