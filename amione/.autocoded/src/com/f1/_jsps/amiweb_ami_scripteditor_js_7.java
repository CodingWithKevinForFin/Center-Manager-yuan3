...
public class amiweb_ami_scripteditor_js_7 extends AbstractHttpHandler{

	public amiweb_ami_scripteditor_js_7() {
	}
	...
	public void handle(HttpRequestResponse request) throws java.io.IOException{
	  ...
	  LocaleFormatter formatter = session == null ? server.getHttpSessionManager().getDefaultFormatter() : session.getFormatter();
          out.print(
            ...
            "//    });\r\n"+
            "	var t = this.editor;\r\n"+
            "	var name = this.acMethodName;\r\n"+
            "	var types = this.acMethodVarTypes \r\n"+
            ...
            "    	if(o.methodName == name)\r\n"+
            "    		tooltip.show(types[o.argumentIndex]+ t.getSelectedText(), wordStartCoord.pageX, wordStartCoord.pageY + 15);\r\n"+
            "    	});\r\n"+
            "    \r\n"+
            ...
            "	this.moveCursor(c);\r\n"+
            "};\r\n"+
            "AmiCodeField.prototype.onKey=funct");
          out.print(
            "ion(e){\r\n"+
