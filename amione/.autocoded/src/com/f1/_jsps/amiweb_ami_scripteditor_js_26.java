...
public class amiweb_ami_scripteditor_js_26 extends AbstractHttpHandler{

	public amiweb_ami_scripteditor_js_26() {
	}
	...
	public void handle(HttpRequestResponse request) throws java.io.IOException{
	  ...
	  LocaleFormatter formatter = session == null ? server.getHttpSessionManager().getDefaultFormatter() : session.getFormatter();
          out.print(
            ...
            "		position = e.key == \"Backspace\"? (editorCP == 0? 0 : editorCP - 1): (e.key == \"Delete");
          out.print(
            "\" || e.altKey || e.ctrlKey)?editorCP: editorCP + 1;\r\n"+
            "	else\r\n"+
            "		position = editorCP;\r\n"+
