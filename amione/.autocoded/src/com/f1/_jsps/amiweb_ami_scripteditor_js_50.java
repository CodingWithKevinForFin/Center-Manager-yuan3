...
public class amiweb_ami_scripteditor_js_50 extends AbstractHttpHandler{

	public amiweb_ami_scripteditor_js_50() {
	}
	...
	public void handle(HttpRequestResponse request) throws java.io.IOException{
	  ...
	  LocaleFormatter formatter = session == null ? server.getHttpSessionManager().getDefaultFormatter() : session.getFormatter();
          out.print(
            ...
            "    	  console.log(\"you double-clicked on:\", \"abc\"); \r\n"+
            "    	  tooltip.show(\"you double-clicked on:\", \"abc\", e.clientX, e.clientY + 10); //this.editor.getSelectedText()\r\n"+
            "    	});\r\n"+
            "    \r\n"+
            "    //\r\n"+
            "    \r\n"+
            ...
            "AmiCodeF");
          out.print(
            "ield.prototype.moveScrollLeft=function(pageX){\r\n"+
