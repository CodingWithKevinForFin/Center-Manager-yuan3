...
public class amiweb_ami_scripteditor_js_49 extends AbstractHttpHandler{

	public amiweb_ami_scripteditor_js_49() {
	}
	...
	public void handle(HttpRequestResponse request) throws java.io.IOException{
	  ...
	  LocaleFormatter formatter = session == null ? server.getHttpSessionManager().getDefaultFormatter() : session.getFormatter();
          out.print(
            ...
            "    	  console.log(\"you double-clicked on:\", this.editor.getSelectedText());\r\n"+
            "    	  tooltip.show(\"you double-clicked on:\", this.editor.getSelectedText(), e.clientX, e.clientY + 10);\r\n"+
            "    	});\r\n"+
            "    \r\n"+
            "    //\r\n"+
            "    \r\n"+
