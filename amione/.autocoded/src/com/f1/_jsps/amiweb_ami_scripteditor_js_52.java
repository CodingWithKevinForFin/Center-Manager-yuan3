...
public class amiweb_ami_scripteditor_js_52 extends AbstractHttpHandler{

	public amiweb_ami_scripteditor_js_52() {
	}
	...
	public void handle(HttpRequestResponse request) throws java.io.IOException{
	  ...
	  LocaleFormatter formatter = session == null ? server.getHttpSessionManager().getDefaultFormatter() : session.getFormatter();
          out.print(
            ...
            "    	 tooltip.show(\"dbl click:\" + this.editor.getSelectedText(), e.clientX, e.clientY + 10);\r\n"+
            "    	});\r\n"+
            "    \r\n"+
            "    //\r\n"+
            "    \r\n"+
            ...
            "    this");
          out.print(
            ".element.style.width=toPx(this.width);\r\n"+
            "	this.editor.resize();\r\n"+
            "}\r\n"+
