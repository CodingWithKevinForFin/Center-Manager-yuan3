...
public class amiweb_ami_scripteditor_js_21 extends AbstractHttpHandler{

	public amiweb_ami_scripteditor_js_21() {
	}
	...
	public void handle(HttpRequestResponse request) throws java.io.IOException{
	  ...
	  LocaleFormatter formatter = session == null ? server.getHttpSessionManager().getDefaultFormatter() : session.getFormatter();
          out.print(
            ...
            "    var cords=this.edit");
          out.print(
            "or.renderer.textToScreenCoordinates(this.editor.selection.getCursor());\r\n"+
            "\r\n"+
