...
public class amiweb_ami_scripteditor_js_66 extends AbstractHttpHandler{

	public amiweb_ami_scripteditor_js_66() {
	}
	...
	public void handle(HttpRequestResponse request) throws java.io.IOException{
	  ...
	  LocaleFormatter formatter = session == null ? server.getHttpSessionManager().getDefaultFormatter() : session.getFormatter();
          out.print(
            ...
            "    	var foo = t.renderer.textToScreenCoordinates(i.start);\r\n"+
            ...
            "  }\r\n"+
            "};\r\n"+
            "AmiCodeField.prototype.getCursorPosition=");
          out.print(
            "function(){\r\n"+
