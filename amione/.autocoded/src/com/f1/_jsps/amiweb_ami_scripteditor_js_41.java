...
public class amiweb_ami_scripteditor_js_41 extends AbstractHttpHandler{

	public amiweb_ami_scripteditor_js_41() {
	}
	...
	public void handle(HttpRequestResponse request) throws java.io.IOException{
	  ...
	  LocaleFormatter formatter = session == null ? server.getHttpSessionManager().getDefaultFormatter() : session.getFormatter();
          out.print(
            ...
            "    var cords=this.editor.re");
          out.print(
            "nderer.textToScreenCoordinates(this.editor.selection.getCursor());\r\n"+
            "\r\n"+
