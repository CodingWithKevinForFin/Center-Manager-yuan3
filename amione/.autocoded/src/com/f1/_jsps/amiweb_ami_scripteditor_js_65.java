...
public class amiweb_ami_scripteditor_js_65 extends AbstractHttpHandler{

	public amiweb_ami_scripteditor_js_65() {
	}
	...
	public void handle(HttpRequestResponse request) throws java.io.IOException{
	  ...
	  LocaleFormatter formatter = session == null ? server.getHttpSessionManager().getDefaultFormatter() : session.getFormatter();
          out.print(
            ...
            "    	var foo = t.renderer.textToScreenCoordinates(i.start, i.end);\r\n"+
            ...
            "  }\r\n"+
            "};\r\n"+
            "AmiCodeField.prototype.getCursorPo");
          out.print(
            "sition=function(){\r\n"+
