...
public class amiweb_ami_scripteditor_js_35 extends AbstractHttpHandler{

	public amiweb_ami_scripteditor_js_35() {
	}
	...
	public void handle(HttpRequestResponse request) throws java.io.IOException{
	  ...
	  LocaleFormatter formatter = session == null ? server.getHttpSessionManager().getDefaultFormatter() : session.getFormatter();
          out.print(
            ...
            "    var cords=this.editor.ren");
          out.print(
            "derer.textToScreenCoordinates(this.editor.selection.getCursor());\r\n"+
            "\r\n"+
