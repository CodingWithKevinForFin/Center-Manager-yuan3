...
public class AmiSolaceFH extends AmiFHBase {
	...
	public static final String PROP_SOLACE_TOPIC = "topic";
			...
			Runnable r = new Runnable() {
				...
				public void run() {
					try {
						...
						final DirectMessageReceiver receiver = service.createDirectMessageReceiverBuilder().withSubscriptions(TopicSubscription.of(topic)).build().start();
	...
	public void init(int id, String name, PropertyController sysProps, PropertyController props, AmiRelayIn amiServer) {
		...
		this.topic = props.getOptional(PROP_SOLACE_TOPIC, "");
